...
export default function StepsLpi({ colorMode }) {
  // Classes de tema
  const bgClasses = {
    dark: "bg-bgFixedDark",
    ...
    <SectionArea className={`${bgClass}`} paddingbot={true}>
      <SectionWrapper className="flex flex-col desktop1:flex-row-reverse gap-[40px] desktop2:gap-0 desktop1:justify-between">
        ...
        <div className="desktop1:w-[550px] desktop2:w-[570px]">
          ...
          <div className="mt-8 flex justify-center desktop1:justify-start">
            <Button
              aria-label={content.texts.steps.ctButtonStepsText}
