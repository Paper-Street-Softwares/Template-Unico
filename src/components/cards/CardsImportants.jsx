...
function CardsImportants({ title, paragraph, colorMode }) {
  ...
  return (
    <div className="relative h-full bg-white shadow-lg max-w-[400px] py-12 px-10 rounded-[18px] flex flex-col gap-4 font-secondFont cursor-pointer group hover:bg-primaryDark hover:text-white transition-all duration-700">
