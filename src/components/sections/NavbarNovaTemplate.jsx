        ...
        <div className="container mx-auto flex items-center m-auto max-w-[1215px] h-full w-[90%] justify-between py-2">
          <div
            className={`flex flex-col z-20 relative  ${
              isScrolled
                ? 'w-[10%] tablet1:w-[15%] tablet2:w-[10%] desktop1:w-[6%] desktop2:w-[15%] desktop3:w-[8%] transition-all duration-700'
                : 'py-3 w-[15%] tablet1:w-[20%] tablet2:w-[15%] desktop1:w-[10%] desktop3:w-[10%] transition-all duration-700'
            }`}
          >
            {' '}
            <img
