...
function HeroTemplateNovo({
  ...
  return (
    ...
    >
      <section className="relative w-full pt-[130px] phone2:pt-[140px] tablet1:pt-[154px] tablet2:pt-[157px] desktop1:pt-[175px] desktop2:pt-[175px] pb-[64px] desktop1:pb-[96px] flex items-center justify-center overflow-hidden font-mainFont">
